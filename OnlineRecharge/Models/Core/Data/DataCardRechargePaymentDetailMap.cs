...
{
    public class DataCardRechargePaymentDetailMap : EntityTypeConfiguration<DataCardRechargePaymentDetails>
    {
        public DataCardRechargePaymentDetailMap()
        {
            //key  
            HasKey(t => t.ID);
            ...
            //table  
            ToTable("DataCardRechargePaymentDetails");
