...
{
    public class DataCardRechargeAPIResponseDetailMap : EntityTypeConfiguration<DataCardRechargeAPIResponseDetails>
    {
        public DataCardRechargeAPIResponseDetailMap()
        {
            //key  
            HasKey(t => t.ID);
            ...
            //table  
            ToTable("DataCardRechargeAPIResponseDetails");
