...
{
    public class InternationalRechargeAPIResponseDetailMap : EntityTypeConfiguration<InternationalRechargeAPIResponseDetails>
    {
        public InternationalRechargeAPIResponseDetailMap()
        {
            //key  
            HasKey(t => t.ID);
            ...
            //table  
            ToTable("InternationalRechargeAPIResponseDetails");
