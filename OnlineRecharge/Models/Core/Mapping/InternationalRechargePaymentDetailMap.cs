...
{
    public class InternationalRechargePaymentDetailMap : EntityTypeConfiguration<InternationalRechargePaymentDetails>
    {
        public InternationalRechargePaymentDetailMap()
        {
            //key  
            HasKey(t => t.ID);
            ...
            //table  
            ToTable("InternationalRechargePaymentDetails");
